...
// MockEnvironmentRepositoryOrchestrator is an autogenerated mock type for the EnvironmentRepositoryOrchestrator type
type MockEnvironmentRepositoryOrchestrator struct {
	mock.Mock
}

// Get provides a mock function with given fields: key, getter
func (_m *MockEnvironmentRepositoryOrchestrator) Get(key string, getter Getter) (string, error) {
...
func (_m *MockEnvironmentRepositoryOrchestrator) GetKey(value string, lister Lister) (string, error) {
...
func (_m *MockEnvironmentRepositoryOrchestrator) List(lister Lister) ([]string, error) {
...
func (_m *MockEnvironmentRepositoryOrchestrator) Set(key string, value string, setters ...Setter) error {
...
func (_m *MockEnvironmentRepositoryOrchestrator) Unset(key string, unSetters ...UnSetter) error {
