...
// MockEnvironmentManagerOrchestrator is an autogenerated mock type for the EnvironmentManagerOrchestrator type
type MockEnvironmentManagerOrchestrator struct {
	mock.Mock
}

// Get provides a mock function with given fields: key, getter
func (_m *MockEnvironmentManagerOrchestrator) Get(key string, getter Getter) (string, error) {
	ret := _m.Called(key, getter)

	var r0 string
	if rf, ok := ret.Get(0).(func(string, Getter) string); ok {
		r0 = rf(key, getter)
	} else {
		r0 = ret.Get(0).(string)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, Getter) error); ok {
		r1 = rf(key, getter)
	} else {
		r1 = ret.Error(1)
	}
...
// GetKey provides a mock function with given fields: value, lister
func (_m *MockEnvironmentManagerOrchestrator) GetKey(value string, lister Lister) (string, error) {
	ret := _m.Called(value, lister)

	var r0 string
	if rf, ok := ret.Get(0).(func(string, Lister) string); ok {
		r0 = rf(value, lister)
	} else {
		r0 = ret.Get(0).(string)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, Lister) error); ok {
		r1 = rf(value, lister)
	} else {
		r1 = ret.Error(1)
	}
...
// List provides a mock function with given fields: lister
func (_m *MockEnvironmentManagerOrchestrator) List(lister Lister) ([]string, error) {
	ret := _m.Called(lister)

	var r0 []string
	if rf, ok := ret.Get(0).(func(Lister) []string); ok {
		r0 = rf(lister)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]string)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(Lister) error); ok {
		r1 = rf(lister)
	} else {
		r1 = ret.Error(1)
	}
...
// Set provides a mock function with given fields: key, value, setters
func (_m *MockEnvironmentManagerOrchestrator) Set(key string, value string, setters ...Setter) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, ...Setter) error); ok {
		r0 = rf(key, value, setters...)
	} else {
		r0 = ret.Error(0)
	}
...
// Unset provides a mock function with given fields: key, unSetters
func (_m *MockEnvironmentManagerOrchestrator) Unset(key string, unSetters ...UnSetter) error {
	_va := make([]interface{}, len(unSetters))
	for _i := range unSetters {
		_va[_i] = unSetters[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, key)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, ...UnSetter) error); ok {
		r0 = rf(key, unSetters...)
	} else {
		r0 = ret.Error(0)
	}
...
// UnsetByValue provides a mock function with given fields: value, byValueUnSetters
func (_m *MockEnvironmentManagerOrchestrator) UnsetByValue(value string, byValueUnSetters ...ByValueUnSetter) error {
	_va := make([]interface{}, len(byValueUnSetters))
	for _i := range byValueUnSetters {
		_va[_i] = byValueUnSetters[_i]
	}
	var _ca []interface{}
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, ...ByValueUnSetter) error); ok {
		r0 = rf(value, byValueUnSetters...)
	} else {
		r0 = ret.Error(0)
	}
